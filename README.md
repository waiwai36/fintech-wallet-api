...
- Production secrets should be stored in GitHub Secrets, environment variables, or a secure vault.
...
dotnet run --project wallet/wallet.csproj --environment Staging
```
